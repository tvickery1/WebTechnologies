...
require_once './sentinel.php';
     ...
     $title = "ica02 - Index: {$_SESSION['username']}";
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <link rel='stylesheet' type="text/css" href='ica02.css'>
  ...
  <body>
    ...
    <div class='content'>
        <table align="center" style="border-collapse: collapse; border-color: blue; border-style: dotted; border-width: 1px">
            ...
            <tr>
                <td><a href="https://thor.net.nait.ca/~tvickery/cmpe2500/ica02/settings.php">Tag Admin</a></td>
